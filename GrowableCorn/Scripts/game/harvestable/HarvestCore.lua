...
local MultitoolRecipes = {
	[tostring( ITEMS.obj_harvest_wood )] = { itemId = ITEMS.blk_scrapwood, quantity = 150 },
	[tostring( ITEMS.obj_harvest_metal )] = { itemId = ITEMS.blk_scrapmetal, quantity = 150 },
	[tostring( ITEMS.obj_harvest_stone )] = { itemId = ITEMS.blk_scrapstone, quantity = 150 },
	[tostring( ITEMS.obj_harvest_metal2 )] = { itemId = ITEMS.blk_metal1, quantity = 150 },
	[tostring( ITEMS.obj_harvest_wood2 )] = { itemId = ITEMS.blk_scrapwood, quantity = 200 },
	[tostring( ITEMS.obj_harvest_crystal )] = { itemId = ITEMS.blk_mineralblue, quantity = 150 },
}
